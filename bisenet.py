...
class BiSeNet(nn.Module):
    def __init__(self, training=True):
        ...
        self.supervision1 = nn.Conv2d(in_channels=256, out_channels=1, kernel_size=1)
        self.supervision2 = nn.Conv2d(in_channels=512, out_channels=1, kernel_size=1)
        
        # Feature fusion module 
        self.ffm = FeatureFusionModule(num_classes=1, in_channels=1024)
...
# bisenet = BiSeNet(training=True)
# bisenet = bisenet.cuda()


# # output, output_sup1, output_sup2 = bisenet(torch.rand((8, 3, 320, 640)).cuda())
# # output, output_sup1, output_sup2 = bisenet(torch.rand((8, 3, 224, 448)).cuda())
# output, output_sup1, output_sup2 = bisenet(torch.rand((8, 3, 196, 320)).cuda())
