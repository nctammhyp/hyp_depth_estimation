...
from depth_model.resnet_bin import FastDepthV2
...
from metric_depth.util import bin_loss
...
def eval_depth(pred, target, criterion=None):
...
def train_fn(device = "cuda:0", load_state = False, state_path = './'):
    ...
    # criterion = L1Loss()
    criterion_ueff = bin_loss.SILogLoss()
    criterion_bins = bin_loss.BinsChamferLoss()
