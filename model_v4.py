...
class FastDepthV2(nn.Module):
  ...
  def forward(self,x):
    ...
    # print("debug 3:", x.min().item(), x.max().item(), "NaN:", torch.isnan(x).any().item())
    layer1= x
    # print(f"fea 2i: {x.size()}")

    x=self.encoder.enc_layer2(x)
    # print(f"fea 4: {x.size()}")

    # print("debug 4:", x.min().item(), x.max().item(), "NaN:", torch.isnan(x).any().item())
    x=self.encoder.enc_layer3(x)
    # print(f"fea 5: {x.size()}")

    layer2=x
    # print(f"fea 5i: {x.size()}")
    ...
    # print(f"fea 8i: {x.size()}")
    x=self.encoder.enc_layer6(x)

    # print(f"fea 10: {x.size()}")
    x=self.encoder.enc_layer7(x)

    # print(f"fea 11: {x.size()}")
    x=self.encoder.enc_layer8(x)

    # print(f"fea 12: {x.size()}")
    x=self.encoder.enc_layer9(x)

    # print(f"fea 13: {x.size()}")
    x=self.encoder.enc_layer10(x)

    # print(f"fea 14: {x.size()}")
    x=self.encoder.enc_layer11(x)

    # print(f"fea 15: {x.size()}")
    x=self.encoder.enc_layer12(x)

    # print(f"fea 16: {x.size()}")
    x=self.encoder.enc_layer13(x)

    # print(f"fea 17: {x.size()}")
    x=self.encoder.enc_layer14(x)

    # print(f"fea 18: {x.size()}")
    x=self.encoder.enc_layer15(x)

    # print(f"fea 19: {x.size()}")
    x=self.encoder.enc_layer16(x)

    # print(f"fea 20: {x.size()}")

    x=self.encoder.enc_layer17(x)

    # print(f"fea 22: {x.size()}")
    x= F.interpolate(self.decoder.conv1(x), scale_factor=2, mode='nearest')

    # print(f"fea 23: {x.size()}")
    x= F.interpolate(self.decoder.conv2(x), scale_factor=2, mode='nearest')

    # print(f"fea 24: {x.size()}")
    x = x+layer3

    # print(f"fea 25: {x.size()}")
    x= F.interpolate(self.decoder.conv3(x), scale_factor=2, mode='nearest')

    # print(f"fea 26: {x.size()}")
    x = x+layer2

    # print(f"fea 27: {x.size()}")
    x= F.interpolate(self.decoder.conv4(x), scale_factor=2, mode='nearest')

    # print(f"fea 28: {x.size()}")
    x = x+layer1

    # print(f"fea 29: {x.size()}")
    x= F.interpolate(self.decoder.conv5(x), scale_factor=2, mode='nearest')

    # print(f"fea 30: {x.size()}")

    # print(f"fea 32: {self.decoder.output(x).size}")
